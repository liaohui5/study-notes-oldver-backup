...
- [Web Workers 线程](https://developer.mozilla.org/zh-CN/docs/Web/API/Web_Workers_API)
- [Websockets 长链接](https://developer.mozilla.org/zh-CN/docs/Web/API/Websockets_API)
